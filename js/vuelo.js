...
function nuevoPasaje(e){
    ...
    if(nombre ==='' || apellido ==='' || telefono ==='' ||  fecha ==='' || hora ==='' || destino === '' || fecha2 ==='' || hora2 ==='' || origen === '' || asiento === ''){
        ...
        userUi.imprimirAlerta('La Fecha de Llegada No debe Ser Menor o igual que la Fecha de Salida', 'error')
...
function cargarEdicion(pasaje){ // debo hacer destructuracion
    ...
    let {nombre, apellido, telefono, fecha, hora, destino,  fecha2, hora2, origen,asiento, id, viaje} = pasaje;
